...
namespace CapaPresentacion
{
    public partial class FrmDepartamentos : Form
    {
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.txtIddepartamento.ReadOnly = !valor;
        }
        ...
        {
            this.dataListado.DataSource = NDepartamentos.Mostrar();
        ...
        {
            this.dataListado.DataSource = NDepartamentos.BuscarNombre(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de registro: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtNombre.Text == string.Empty)
                {
                    ...
                    erroricono.SetError(txtNombre, "Ingrese una descripcion");
                }
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NDepartamentos.Insertar(this.txtNombre.Text.Trim().ToUpper(), this.chkEstado.Text.Trim());
                    }
                    else
                    {
                        rpta = NDepartamentos.Editar(Convert.ToInt32(this.txtIddepartamento.Text), this.txtNombre.Text.Trim().ToUpper(), this.chkEstado.Text.Trim());
                    }
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = NDepartamentos.Eliminar(Convert.ToInt32(Codigo));
